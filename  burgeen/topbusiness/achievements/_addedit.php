...
<fieldset class="mandatory-advanced">
	...
	<div class="container">
		...
		<div class="data"><?php dpa_addedit_warning( 'is_active' ); ?><p class="hint"><input type="checkbox" name="is_active" id="is_active" <?php dpa_addedit_value( 'is_active' ); ?>> <?php _e( "Is this Achievement active?", 'dpa' ); ?></p></div>
		<div style="clear: left;"></div>
	</div>

	<div class="container">
		<div class="label"><?php _e( 'Hidden', 'dpa' ); ?></div>
		<div class="data"><p class="hint"><input type="checkbox" name="is_hidden" id="is_hidden" <?php dpa_addedit_value( 'is_hidden' ); ?>> <?php _e( "Hide this Achievement in the Directory and from search results?", 'dpa' ); ?></p></div>
		<div style="clear: left;"></div>
	</div>
