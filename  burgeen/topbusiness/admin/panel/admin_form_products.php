		...
		<div id="products_acvitation_data">
			...
			<fieldset class="panda-admin-fieldset"><legend><?php _e('Template','pandathemes') ?></legend>
				...
				<div class="tmpl_radio">
					...
					<input type="radio" value="t1" name="product_template" id="p1_template" <?php if ( ! $panda_pr['product_template'] || $panda_pr['product_template'] == 't1' ) : echo 'checked="checked"'; endif; ?> />
					<label for="p1_template"><?php _e('Template','pandathemes') ?> #1</label>
				</div>
	
				<div class="tmpl_radio">
					<label class="lable-img" for="p2_template"><img src="<?php echo $template_url ?>/admin/graphics/templates/products_2.gif" width="135" height="110"></label>
					<input type="radio" value="t2" name="product_template" id="p2_template" <?php if ( $panda_pr['product_template'] == 't2' ) : echo 'checked="checked"'; endif; ?> />
					<label for="p2_template"><?php _e('Template','pandathemes') ?> #2</label>
				</div>
		...
		<fieldset class="panda-admin-fieldset"><legend><?php _e('Catalog page','pandathemes') ?></legend>
			...
			<table><tr>
				...
				<td>
					<table><tr>
						<td class="size3">
							<input type="checkbox" name="after_catalog" id="after_catalog" class="checkbox-toggle" value="enable" <?php if ($panda_pr['after_catalog']=='enable') { echo 'checked' ;} ?> /> 
						</td>
						<td>
		...
		<fieldset class="panda-admin-fieldset"><legend><?php _e('Product page','pandathemes') ?></legend>
			...
			<table><tr>
				...
				<td>
					<table><tr>
						<td class="size3">
							<input type="checkbox" name="related_products" id="related_products" class="checkbox-toggle" value="yes" <?php if ($panda_pr['related_products']) { echo 'checked' ;} ?> />
						</td>
						<td>
			...
			<table><tr>
				...
				<td>
					<table><tr>
						<td class="size3">
							<input type="checkbox" name="after_product" id="after_product" class="checkbox-toggle" value="enable" <?php if ($panda_pr['after_product']=='enable') { echo 'checked' ;} ?> /> 
						</td>
						<td>
			...
			<table><tr>
				...
				<td>
					<table><tr>
						<td class="size3">
							<input type="checkbox" name="after_purchase" id="after_purchase" class="checkbox-toggle" value="enable" <?php if ($panda_pr['after_purchase']=='enable') { echo 'checked' ;} ?> /> 
						</td>
						<td>
