<?php
	...
	function update_notifier() { 
		...
		<div class="wrap">
			...
			<div>
				...
				<div style="display:table;">
					<ol style="margin-top:0;">
						<li>To update the theme, check your inbox. Each one customer has got an updated version by email.</li>
						<li>Deactivate & delete the current version of <?php echo $theme_data['Name']; ?> and install new one.</li>
					</ol>
				</div>
				<p>
			...
			<h2 class="nav-tab-wrapper">
				...
				<a href="http://pandathemes.com/wordpress-themes/topbusiness/" target="_blank" class="nav-tab">About Theme</a>
	...
	function get_latest_theme_version($interval) {
		...
		$notifier_file_url = 'http://pandathemes.com/xml/topbusiness-notifier.xml';
		
		$db_cache_field = 'topbusiness-notifier-cache';
		$db_cache_field_last_updated = 'topbusiness-notifier-last-updated';
